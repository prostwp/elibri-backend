...
Reads BTC 4h OHLCV from ml-training/data/ETHUSDT_4h.parquet, computes a
...
forward-returns array to telegram-bot/data/pattern_indexes/ETHUSDT_4h/.
...
PARQUET = Path("/Users/admin/NodeElibiri/elibri-backend/ml-training/data/ETHUSDT_4h.parquet")
OUTPUT_DIR = BOT_ROOT / "data" / "pattern_indexes" / "ETHUSDT_4h"
